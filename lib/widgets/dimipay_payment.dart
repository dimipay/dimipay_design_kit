              ...
              child: Column(
                children: [
                  _PaymentOption(
                    title: 'X CHECK',
                    subtitle: '현대카드 (370*)',
                    assetPath: 'assets/images/cards/default.svg',
...
class _CardDetail extends StatelessWidget {
  ...
  const _CardDetail({super.key, required this.title, required this.subtitle});
...
class _AddCardButton extends StatelessWidget {
  const _AddCardButton({super.key});
